...
<div class="header">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo U("Home/Index/petslist");?>">宠物列表</a> </li>
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <div class="form-group">
                            <label>宠物图片</label>
                            <br>
                            <img src="<?php echo ($list[0]["img"]); ?>" id="firstphopo">
                        ...
                        <div class="form-group">
                            <label>宠物名</label>
                            <input type="text" id="petsname" name="petsname" class="form-control" value="<?php echo ($list[0]["petname"]); ?>">
                        </div>
                        <div class="form-group">
                            <label>所属房间</label>
                            <select name="roomsclassify" id="roomsclassify" class="form-control">
                                <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mode2): $mod = ($i % 2 );++$i;?><option <?php echo ($mode2["se"]); ?> value="<?php echo ($mode2["id"]); ?>"><?php echo ($mode2["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>选择护工</label>
                            <br>
                            <?php if(is_array($cares)): $i = 0; $__LIST__ = $cares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$care_mod): $mod = ($i % 2 );++$i;?><label class="careworker"><input type="checkbox" name="careworkers[]" value="<?php echo ($care_mod["id"]); ?>" <?php echo ($care_mod["check"]); ?>><?php echo ($care_mod["name"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                        <div class="form-group">
                            <label>种类</label>
                            <input type="text" id="category" name="category" class="form-control" value="<?php echo ($list[0]["breed"]); ?>">
                        </div>
                        <div class="form-group">
                            <label>年龄</label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger" name="delete" onclick="form1.action='/Pets/index.php/Home/Index/pet/id/1.html';form1.submit();"
