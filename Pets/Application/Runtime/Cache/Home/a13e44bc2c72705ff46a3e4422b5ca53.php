        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane active in" id="home">
                <form id="tab" method='post'>
                    ...
                    <div class="form-group">
                        <label>电话</label>
                        <input type="text" name="phone" id="phone" value="<?php echo ($list["phone"]); ?>"
                               class="form-control">
                    </div>
                    <div class="form-group">
                        <label>身份证号</label>
                        <input type="text" name="idcard" id="idcard" value="<?php echo ($list["idcard"]); ?>"
                               class="form-control">
                    </div>
                    <div class="form-group">
                        <label>地址</label>
                        <textarea name="address" id="address" rows="3"
                                  class="form-control"><?php echo ($list["address"]); ?></textarea>
                    </div>
