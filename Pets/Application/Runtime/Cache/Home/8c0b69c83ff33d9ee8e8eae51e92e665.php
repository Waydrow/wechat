...
<div class="main-content">
    <div class="btn-toolbar list-toolbar">
        <a href="<?php echo U("Home/Index/pet");?>">
        <button class="btn btn-primary"><i class="fa fa-plus"></i>新添加宠物</button>
        </a>
        <div class="btn-group">
        </div>
    </div>
    <table class="table">
        ...
        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                ...
                <td><?php echo ($vo["breed"]); ?></td>
                <td><?php echo ($vo["age"]); ?></td>
                <td><?php echo ($vo["sex"]); ?></td>
                <td><?php echo ($vo["entertime"]); ?></td>
                <td>
                    <a href="<?php echo U("Home/Index/pet?id=$vo[id]");?>"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo U("Home/Index/deletepet?id=$vo[id]");?>" role="button" data-toggle="modal"
