...
<div class="main-content">
            ...
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        ...
                        <div class="form-group">
                            <label>宠物名</label>
                            <input type="text" id="petsname" name="petsname" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>所属房间</label>
                            <select name="roomsclassify" id="roomsclassify" class="form-control">
                                <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mode2): $mod = ($i % 2 );++$i;?><option value="<?php echo ($mode2["id"]); ?>"><?php echo ($mode2["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>选择护工</label>
                            <br>
                            <?php if(is_array($cares)): $i = 0; $__LIST__ = $cares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$care_mod): $mod = ($i % 2 );++$i;?><label class="careworker"><input type="checkbox" name="careworkers[]" value="<?php echo ($care_mod["id"]); ?>"><?php echo ($care_mod["name"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                        <div class="form-group">
                            <label>种类</label>
                        ...
                        <div class="form-group">
                            <label>到达时间</label>
                            <input type="text" id="entertime" name="entertime" class="form-control">
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger" name="delete" onclick="form1.action='/Pets/index.php/Home/Index/petsadd.html';form1.submit();"
    ...
    <script type="text/javascript" src="/Pets/Public/lib/jquery-1.11.1.min.js"></script>
    <script type="text/javascript">
        $("#save").click(function () {
