            ...
            <div class="tab-pane active in" id="home">
                <form id="tab" method='post'>
                    <div class="form-group">
                        <label>房间名</label>
                        <input type="text" name="name" id="name" value="<?php echo ($list[0]["name"]); ?>"
                               class="form-control">
                    </div>
                    <div class="form-group">
                        <label>房间容量</label>
                        <input type="text" name="capacity" id="capacity" value="<?php echo ($list[0]["capacity"]); ?>" class="form-control">
                    </div>
            </div>
        </div>
