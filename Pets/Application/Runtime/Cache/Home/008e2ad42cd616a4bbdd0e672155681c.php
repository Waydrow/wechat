            ...
            <div class="tab-pane active in" id="home">
                <form id="tab" method='post'>
                    <div class="form-group">
                        <label>用户名</label>
                        <input type="text" name="username" id="username" value="<?php echo ($list[0]["username"]); ?>"
                               class="form-control">
                    </div>
                    <div class="form-group">
                        <label>密码</label>
                    ...
                    <div class="form-group">
                        <label>真实姓名</label>
                        <input type="text" name="realname" id="realname" value="<?php echo ($list[0]["realname"]); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>性别</label>
                        <input type="text" name="sex" id="sex" value="<?php echo ($list[0]["sex"]); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>身份证号</label>
                        <input type="text" name="idcard" id="idcard" value="<?php echo ($list[0]["idcard"]); ?>"
                               class="form-control">
                    </div>
                    <div class="form-group">
                        <label>电话</label>
                        <input type="text" name="phone" id="phone" value="<?php echo ($list[0]["phone"]); ?>"
                               class="form-control">
                    </div>
                    <div class="form-group">
                        <label>地址</label>
                        <textarea name="address" id="address" rows="3"
                                  class="form-control"><?php echo ($list[0]["address"]); ?></textarea>
                    </div>
