...
<div class="content">
    <div class="main-content">
        ...
        <a class="btn btn-primary" href="<?php echo U("Home/Index/careworker");?>">添加新护工</a>
<table class="table">
    <thead>
    <tr>
        <th>#</th>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <a href="<?php echo U("Home/Index/careworker?id=$vo[id]");?>"><i class="fa fa-pencil"></i></a>
                <a href="<?php echo U("Home/Index/deletecareworker?id=$vo[id]");?>" role="button" data-toggle="modal"
