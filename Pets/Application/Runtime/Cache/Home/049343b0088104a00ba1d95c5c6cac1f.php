...
<div class="content">
    ...
    <a href="<?php echo U("Home/Index/room");?>" class="btn btn-primary"><i class="fa fa-plus"></i> 添加房间</a>
    <div class="btn-group">
    </div>
</div>
<table class="table" style="width: 800px;">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["nownum"]); ?></td>
            <td>
                <a href="<?php echo U("Home/Index/room?id=$vo[id]");?>"><i class="fa fa-pencil"></i></a>
                <a href="<?php echo U("Home/Index/deleteroom?id=$vo[id]");?>" role="button" data-toggle="modal"
